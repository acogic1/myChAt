...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rootRef.child("Users").child(messageReceiverId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.get().load(userThumb).networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.drawable.default_profile)
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==Gallery_Pick && resultCode==RESULT_OK && data!=null){
            ...
            loadingBar.setMessage("Please wait, while your chat messaging is sending...");
            loadingBar.show();
            ...
            filePath.putFile(ImageUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                ...
                public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                    if(task.isSuccessful()){
                        ...
                        rootRef.updateChildren(messageBodyDetalis, new DatabaseReference.CompletionListener() {
                            @Override
                        ...
                        Toast.makeText(ChatActivity.this,"Picture sent successifully",Toast.LENGTH_LONG).show();
                        loadingBar.dismiss();
                    }
                    else {
