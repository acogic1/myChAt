...
public class AllUsersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SearchButton=(ImageButton)findViewById(R.id.serch_btn);
     ...
     private void SearchForPeopleAndFriends(String searchUserName){
        ...
        Toast.makeText(AllUsersActivity.this,"Searching...",Toast.LENGTH_LONG).show();

         Query searchPepleAndFriends=allDatabaseUsersRef.orderByChild("user_name")
